    ...
    def _build_quick_setup(self, parent):
        ...
        ttk.Label(parent, foreground="#888", wraplength=820, justify="left",
                  text="Режим задаёт сразу всё: риск на сделку, число одновременных "
                       ...
                       "Торговля не останавливается: дневной порог убытка, лимит "
                       "просадки и пауза после серии убытков выключены — бот "
                       "отрабатывает всё торговое время. Вместо остановки "
                       "ограничивается размер КАЖДОГО убытка: обязательный стоп-лосс, "
                       "риск на сделку, потолок совокупного риска и снижение объёма "
                       "по мере серии неудач. Включить остановки обратно — на вкладке "
                       "«Настройка», раздел «Риск», группа «Просадка / серии убытков»."
