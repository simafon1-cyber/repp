    ...
    def _apply_strategy(self):
        ...
        if strategies_mod.черновик(strategy):
            messagebox.showwarning(
                ...
                "Чтобы её включить, по регламенту нужно:\n"
                "  1) заполнить и заверить паспорт версии С-001;\n"
                "  2) пройти демо-приёмку с разбором каждой сделки;\n"
                "  3) получить письменное согласие проверяющего.\n\n"
                "Кнопкой это не делается. Ничего не изменено.")
            return
